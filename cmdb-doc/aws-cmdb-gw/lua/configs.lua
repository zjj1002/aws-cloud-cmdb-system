...
token_secret = "La1N8tB3auVWE6BZnMzFkprkqwP6xeYauY5swXOBlZwTgFo5ghMSTV3kYj5f4LO1"
logs_file = '/var/log/gw.log'

-- 注意：rewrite_cache_token要和cmdb-admin里面的secret_key保持一致
rewrite_cache_token = 'La1Nst23auVWE6BZnMzFkprkqwP6xeYauY5swXOBlZwTgFo5ghMSTV3kYj5f4LOK'  
