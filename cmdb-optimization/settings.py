...
DEFAULT_DB_DBPWD = os.getenv('DEFAULT_DB_DBPWD', 'Chuanhao1.')
DEFAULT_DB_DBNAME = os.getenv('DEFAULT_DB_DBNAME', 'cmdb_optimization')
...
READONLY_DB_DBPWD = os.getenv('READONLY_DB_DBPWD', 'Chuanhao1.')
READONLY_DB_DBNAME = os.getenv('READONLY_DB_DBNAME', 'cmdb_optimization')

# 这是读aksk的数据库，
READ_AKSK_DB_DBHOST = os.getenv('DEFAULT_DB_DBHOST', '127.0.0.1')
READ_AKSK_DB_DBPORT = os.getenv('DEFAULT_DB_DBPORT', '3306')
READ_AKSK_DB_DBUSER = os.getenv('DEFAULT_DB_DBUSER', 'root')
READ_AKSK_DB_DBPWD = os.getenv('DEFAULT_DB_DBPWD', 'Chuanhao1.')
READ_AKSK_DB_DBNAME = os.getenv('DEFAULT_DB_DBNAME', 'cmdb_cmdb')
...
DEFAULT_REDIS_DB = 1 #默认和cmdb-admin保持一致
...
# CMDB_TASK_DB_HOST = os.getenv('CMDB_TASK_DB_HOST', '172.31.128.219')
...
settings = dict(
    ...
    read_aksk_db =  {
    "DBHOST_KEY": READ_AKSK_DB_DBHOST,
    "DBPORT_KEY": READ_AKSK_DB_DBPORT,
    "DBUSER_KEY": READ_AKSK_DB_DBUSER,
    "DBPWD_KEY": READ_AKSK_DB_DBPWD,
    "DBNAME_KEY": READ_AKSK_DB_DBNAME,
}
)
